...
def RSPC_notif(sender, recipient, type):
    ...
    if type == "Proposal Created":
        verb = "There is a new project proposal for you to forward to RSPC."
    elif type == "Co-PI":
        ...
        verb = "There is a project registration request for you to forward to RSPC."
        ...
        verb = "There is a new staff document uploaded for you to approve."
